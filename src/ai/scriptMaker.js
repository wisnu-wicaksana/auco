...
5. WORD COUNT & DURATION ENFORCEMENT: 1 minute of video requires EXACTLY 150 words. You MUST calculate the required word count based on the requested duration (e.g., 2 minutes = MINIMUM 300 words). To reach long word counts, you MUST write multiple long, detailed paragraphs expanding on sub-topics, history, facts, and examples. DO NOT SUMMARIZE. If you output less than the calculated word count, the system will crash. If no duration is requested, default to 150 words.
